...
declare global {
  ...
  const cachedEventHandler: typeof import('/workspaces/nuxt_small_land/node_modules/nitropack/dist/runtime')['cachedEventHandler']
  const cachedFunction: typeof import('/workspaces/nuxt_small_land/node_modules/nitropack/dist/runtime')['cachedFunction']
  ...
  const defineCachedEventHandler: typeof import('/workspaces/nuxt_small_land/node_modules/nitropack/dist/runtime')['defineCachedEventHandler']
  const defineCachedFunction: typeof import('/workspaces/nuxt_small_land/node_modules/nitropack/dist/runtime')['defineCachedFunction']
  const defineEventHandler: typeof import('h3')['defineEventHandler']
  const defineLazyEventHandler: typeof import('h3')['defineLazyEventHandler']
  const defineNitroPlugin: typeof import('/workspaces/nuxt_small_land/node_modules/nitropack/dist/runtime')['defineNitroPlugin']
  ...
  const defineRenderHandler: typeof import('/workspaces/nuxt_small_land/node_modules/nitropack/dist/runtime')['defineRenderHandler']
  ...
  const getRouteRules: typeof import('/workspaces/nuxt_small_land/node_modules/nitropack/dist/runtime')['getRouteRules']
  ...
  const nitroPlugin: typeof import('/workspaces/nuxt_small_land/node_modules/nitropack/dist/runtime')['nitroPlugin']
  ...
  const useNitroApp: typeof import('/workspaces/nuxt_small_land/node_modules/nitropack/dist/runtime')['useNitroApp']
  const useRuntimeConfig: typeof import('/workspaces/nuxt_small_land/node_modules/nitropack/dist/runtime')['useRuntimeConfig']
  const useSession: typeof import('h3')['useSession']
  const useStorage: typeof import('/workspaces/nuxt_small_land/node_modules/nitropack/dist/runtime')['useStorage']
